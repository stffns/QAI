...
class QADatabaseAnalyzer:
    ...
    def analyze_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tables_without_data": [table for table, count in table_sizes.items() if count == 0]
        }
    ...
    def generate_migration_script(self) -> str:
        ...
        for missing_index in performance_analysis["missing_indexes"]:
            ...
            migrations.append(f"CREATE INDEX IF NOT EXISTS idx_{table}_{column} ON {table}({column});")
