...
class AppEnvironmentConfig(BaseModel):
    ...
    logs_directory: str = Field(default="logs", description="Directory for log files")
    cache_directory: str = Field(
        default="cache", description="Directory for cache files"
    )
    temp_directory: str = Field(
        default="temp", description="Directory for temporary files"
    )
