...
class ServerConfig(BaseModel):
    ...
    max_message_size: int = Field(default=1048576, ge=1024, description="Maximum message size in bytes (1MB)")
    max_queue_size: int = Field(default=32, ge=1, description="Maximum message queue size")
...
class RateLimitConfig(BaseModel):
    ...
    max_requests_per_minute: int = Field(default=60, ge=1, description="Maximum requests per minute")
...
class WebSocketLoggingConfig(BaseModel):
    ...
    log_connections: bool = Field(default=True, description="Enable WebSocket connection logging")
