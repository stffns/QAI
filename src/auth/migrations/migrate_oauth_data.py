...
USERS_DATA = [
    # STA Mexico
    {
        "email": "test.sta.mx11@endtest-mail.io",
        "given_name": "Lucia",
        "family_name": "Alamos Lara",
        "phone_number": "+573219059012",
        "gender": Gender.FEMALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "mx",
        "product": OAuthProduct.ONE_APP,
    },
    # STA Chile
    {
        "email": "sodexo.100297329@endtest-mail.io",
        "given_name": "Lucia",
        "family_name": "Alamos Lara",
        "phone_number": "+573219059012",
        "gender": Gender.FEMALE,
    ...
    {
        "email": "colombia.sta@endtest-mail.io",
        "given_name": "Alejandro",
        "family_name": "Cabrera",
        "phone_number": "+573219036969",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
    ...
    {
        "email": "QAStressTestCO1646@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.ONE_APP1,
    },
    {
        "email": "QAStressTestCO1752@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
        ...
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.ONE_APP2,
    },
    {
        "email": "QAStressTestCO1256@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
        ...
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.ONE_APP3,
    },
    {
        "email": "QAStressTestCO1738@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
        ...
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.ONE_APP4,
    },
    # STA Uruguay
    {
        "email": "Uy.sta@endtest-mail.io",
        "given_name": "Lionel",
        "family_name": "Messi",
        "phone_number": "+573114961227",
        "gender": Gender.FEMALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "uy",
    ...
    {
        "email": "sta.peru@endtest-mail.io",
        "given_name": "Martin",
        "family_name": "Pruebas",
        "phone_number": "+51902566821",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "pe",
    ...
    {
        "email": "QAStressTestpe1752@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
    ...
    {
        "email": "QAStressTestpe1256@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
    ...
    {
        "email": "QAStressTestpe3157@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
    ...
    {
        "email": "QAStressTestpe1408@endtest-mail.io",
        "given_name": "Qatesting",
        "family_name": "Automation",
        "phone_number": "+5521968862606",
        "gender": Gender.MALE,
    ...
    # STA Panama
    {
        "email": "QA1Testpa0725@endtest-mail.io",
        "given_name": "Prueba",
        "family_name": "Test",
        "phone_number": "+573155453551",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "pa",
    ...
    # UAT users
    {
        "email": "ciam-mix@endtest-mail.io",
        "given_name": "test",
        "family_name": "test",
    ...
    {
        "email": "user.uat.co@endtest-mail.io",
        "given_name": "test",
        "family_name": "test",
        "phone_number": "+33663005232",
        "gender": Gender.FEMALE,
    ...
    # M-APP users
    {
        "email": "register.sta.co@endtest-mail.io",
        "given_name": "Usuario",
        "family_name": "Sta",
        "phone_number": "+50769990981",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.M_APP,
    },
    {
        "email": "creatingnewuserforpanama.sta.pa@endtest-mail.io",
        "given_name": "Usuario",
        "family_name": "Panamastauno",
        "phone_number": "+50769990981",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.STA,
    ...
    {
        "email": "merqasta01@endtest-mail.io",
        "given_name": "Usuario",
        "family_name": "Panamastauno",
        "phone_number": "+50769990981",
        "gender": Gender.MALE,
    ...
    # EVA users
    {
        "email": "qa.uat.soco.lu+1@gmail.com",
        "given_name": "test",
        "family_name": "test",
        "phone_number": "+33663005232",
        "gender": Gender.FEMALE,
        ...
        "environment": OAuthEnvironment.UAT,
        "country_code": "lu",
        "product": OAuthProduct.EVA,
    },
    {
        "email": "qa.sta.soco+22+06+2021@gmail.com",
        "given_name": "Sathish",
        "family_name": "Chinnadurai",
        "phone_number": "+33663005232",
        "gender": "Homme",
        "password": "Test12345#",
        "environment": OAuthEnvironment.UAT,
    ...
    {
        "email": "qa.uat.soco.ro+4@gmail.com",
        "given_name": "test",
        "family_name": "test",
        "phone_number": "+33617443459",
        "gender": Gender.MALE,
        "password": "Test12345#",
        "environment": OAuthEnvironment.UAT,
        "country_code": "ro",
...
APPLICATIONS_DATA = [
    # ONE-APP
    {
        "client_id": "547887ef-6ee7-492d-bad8-1edfd7ba0999",
        "name": "One App Mexico",
        "environment": OAuthEnvironment.STA,
        "country_code": "mx",
        "product": OAuthProduct.ONE_APP,
        "callback_url": "http://localhost/oidc/callback",
        "needs_resource_param": True,
        "resource_url": "https://api.sta.pluxee.app",
    },
    {
        "client_id": "afa77d29-3d61-44fb-947b-af0965f35d5e",
        "name": "One App Chile",
        "environment": OAuthEnvironment.STA,
        "country_code": "cl",
        "product": OAuthProduct.ONE_APP,
    ...
    {
        "client_id": "6836636f-f746-47c5-8259-48c380a6d963",
        "name": "One App Colombia",
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.ONE_APP,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "09bb93a7-7524-40b9-af45-56cf4362dac6",
        "name": "One App Uruguay",
        "environment": OAuthEnvironment.STA,
        "country_code": "uy",
        "product": OAuthProduct.ONE_APP,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "7b0dfcf3-adbf-48c3-853e-0ab76142a2b4",
        "name": "One App Peru",
        "environment": OAuthEnvironment.STA,
        "country_code": "pe",
        "product": OAuthProduct.ONE_APP,
    ...
    {
        "client_id": "d478ee6a-000b-4987-ae0e-f700d9c8cfed",
        "name": "One App Panama",
        "environment": OAuthEnvironment.STA,
        "country_code": "pa",
        "product": OAuthProduct.ONE_APP,
    ...
    # UAT ONE-APP
    {
        "client_id": "3ed1105d-4651-4d83-9052-4896284a4201",
        "name": "One App Chile UAT",
        "environment": OAuthEnvironment.UAT,
        "country_code": "cl",
        "product": OAuthProduct.ONE_APP,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "2a717089-ad1e-43ff-8450-445754559eaa",
        "name": "One App Colombia UAT",
        "environment": OAuthEnvironment.UAT,
        "country_code": "co",
        "product": OAuthProduct.ONE_APP,
        "callback_url": "http://localhost/oidc/callback",
    ...
    # M-APP
    {
        "client_id": "99a67715-bafe-424b-86a8-9ac281a8a995",
        "name": "M-App Colombia",
        "environment": OAuthEnvironment.STA,
        "country_code": "co",
        "product": OAuthProduct.M_APP,
    ...
    {
        "client_id": "5d840b11-8e78-4947-8f4a-823e1d687bbd",
        "name": "M-App Panama",
        "environment": OAuthEnvironment.STA,
        "country_code": "pa",
        "product": OAuthProduct.M_APP,
    ...
    {
        "client_id": "6d6ea62a-0885-4191-b037-483ea778b69a",
        "name": "M-App Chile",
        "environment": OAuthEnvironment.STA,
        "country_code": "cl",
        "product": OAuthProduct.M_APP,
    ...
    {
        "client_id": "58feae71-14b5-4e25-9e75-bb8ce19eaa2d",
        "name": "M-App Brasil",
        "environment": OAuthEnvironment.STA,
        "country_code": "br",
        "product": OAuthProduct.M_APP,
    ...
    # EVA
    {
        "client_id": "47243233-146c-41f8-b306-61e6d0d3fb11",
        "name": "EVA Luxembourg UAT",
        "environment": OAuthEnvironment.UAT,
        "country_code": "lu",
        "product": OAuthProduct.EVA,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "6e8297c6-c221-4909-8228-e7b51462acc5",
        "name": "EVA Tunisia UAT",
        "environment": OAuthEnvironment.UAT,
        "country_code": "tn",
        "product": OAuthProduct.EVA,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "9a2d7f6f-83a6-402e-9c1e-c691f12e71d1",
        "name": "EVA Romania UAT",
        "environment": OAuthEnvironment.UAT,
        "country_code": "ro",
        "product": OAuthProduct.EVA,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "0f2ba049-b2a2-447c-9cff-42eaf38d5717",
        "name": "EVA Luxembourg STA",
        "environment": OAuthEnvironment.STA,
        "country_code": "lu",
        "product": OAuthProduct.EVA,
        "callback_url": "http://localhost/oidc/callback",
    ...
    {
        "client_id": "13d164db-dcc3-4462-8c42-1970d888cadf",
        "name": "EVA Tunisia STA",
        "environment": OAuthEnvironment.STA,
        "country_code": "tn",
        "product": OAuthProduct.EVA,
        "callback_url": "http://localhost/oidc/callback",
...
def migrate_environment_configs(session: Session) -> None:
    ...
    for config_data in ENVIRONMENT_CONFIGS:
        existing = (
            session.query(OAuthEnvironmentConfig)
            .filter(OAuthEnvironmentConfig.environment == config_data["environment"])
            .first()
        )
...
def migrate_jwks(session: Session) -> None:
    ...
    for jwk_data in JWKS_DATA:
        existing = (
            session.query(OAuthJWK)
            .filter(OAuthJWK.environment == jwk_data["environment"])
            .first()
        )
...
def migrate_users(session: Session) -> None:
    ...
    for user_data in USERS_DATA:
        existing = (
            ...
            .filter(OAuthUser.email == user_data["email"])
            .first()
        )
        ...
        if not existing:
            ...
            session.add(user)
            logger.info(
                f"Added user: {user.email} ({user.environment}/{user.country_code}/{user.product})"
            )
...
def migrate_applications(session: Session) -> None:
    ...
    for app_data in APPLICATIONS_DATA:
        existing = (
            session.query(OAuthApplication)
            .filter(OAuthApplication.client_id == app_data["client_id"])
            .first()
        )
        ...
        if not existing:
            ...
            logger.info(
                f"Added application: {application.name} ({application.client_id})"
            )
