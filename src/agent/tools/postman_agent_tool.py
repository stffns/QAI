...
class PostmanVariablesAgentTool:
    ...
    def initialize_variables_for_new_test(
        ...
        success = self.manager.initialize_execution_variables(
...
def update_postman_vars(
    app: str, env: str, country: str, values: Dict[str, Any]
) -> Dict[str, Any]:
    """Helper para actualizar variables de ejecución"""
    return postman_agent_tool.update_test_variables(app, env, country, values)


def create_postman_env_file(
    app: str, env: str, country: str
) -> Optional[Dict[str, Any]]:
...
if __name__ == "__main__":
    ...
    if variables:
        ...
        new_values = {"api_key": "sk_test_new_123", "user_id": "user_test_456"}
