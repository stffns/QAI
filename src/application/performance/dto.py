...
class ScenarioParams(BaseModel):
    ...
    scenario_slug: Optional[str] = Field(default=None, description="Logical scenario name")
    endpoint_slug: Optional[str] = Field(default=None, description="Logical endpoint or full URL")
    rps_target: Optional[float] = Field(default=None, ge=0, description="Target requests per second")
    feeder_file: Optional[str] = Field(default=None, description="Path to feeder file (CSV/JSON)")
...
class SimulationParams(BaseModel):
    ...
    app_slug: str = Field(..., description="Application identifier, e.g., ecommerce, payments")
    ...
    duration_sec: int = Field(60, ge=1, le=86400, description="Test duration in seconds")
    ...
    scenario_slug: Optional[str] = Field(default=None, description="Scenario name for single-scenario runs")
    rps_target: Optional[float] = Field(default=None, ge=0, description="Target RPS for single-scenario")
    feeder_file: Optional[str] = Field(default=None, description="Feeder file for single-scenario")
    injection_profile: Optional[List[dict[str, Any]]] = Field(
    ...
    scenarios: Optional[List[ScenarioParams]] = Field(
        default=None, description="List of scenarios for multi-endpoint/multi-profile runs"
    )
    notes: Optional[str] = Field(default=None, description="Free-text notes for the execution")

    # Optional: Assertions tuning (runner may map to -D props)
    enable_assertions: Optional[bool] = Field(default=None, description="Enable/disable assertions")
    fail_pct_lt: Optional[float] = Field(default=None, ge=0, description="Max failed requests percentage")
    p95_lt: Optional[float] = Field(default=None, ge=0, description="p95 (percentile3) response time upper bound in ms")
    p99_lt: Optional[float] = Field(default=None, ge=0, description="p99 (percentile4) response time upper bound in ms")
    mean_rt_lt: Optional[float] = Field(default=None, ge=0, description="Mean response time upper bound in ms")
    ...
    ramp_down: Optional[int] = Field(default=None, ge=0, description="Ramp-down seconds")
    to_users: Optional[int] = Field(default=None, ge=1, description="Target users (if applicable)")
    pause_ms: Optional[int] = Field(default=None, ge=0, description="Pause between chained endpoints in ms")
